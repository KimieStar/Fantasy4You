...
namespace ePOSOne.btnProduct
{
    public class Button_WOC : Button
    {
        ...
        private Color _onHoverButtonColor = Color.Tan;
        private Color _textColor = Color.White;
        private Color _onHoverTextColor = Color.Gray;
        private Color _onHoverBackColor = Color.FromArgb(125, Color.Black);
        private Color _BackColor = Color.FromArgb(125, Color.Black);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //BackColor
            brush.Dispose();
            brush = new SolidBrush(_isHovering ? _onHoverBackColor : _BackColor);
